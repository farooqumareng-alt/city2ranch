...
insert into pricing_rules (base_fee_cents, per_mile_cents, min_fee_cents, is_active, note)
select 1500, 150, 2500, true, 'PLACEHOLDER — replace with real pilot pricing before launch'
