...
export const metadata: Metadata = {
  title: "Shop for Me",
  description:
    "Submit a private concierge shopping request to City2Ranch — groceries, essentials and errands delivered to your ranch or rural property.",
};
...
/**
 * The actual Concierge intake form — moved here from /request-service
 * itself (approved UX blueprint: Request Service is now a three-choice
 * entry point, not this form directly). ?tier= and ?ref= links land
 * straight here via the redirect in ../page.tsx, since both signals
 * (membership interest, a referral QR code) always mean Concierge.
 */
export default async function ConciergeRequestPage({
  ...
  return (
    <Container className="flex flex-col gap-10 py-16 sm:py-24">
      <SectionHeading
        eyebrow="SHOP FOR ME"
        title="Concierge Shopping Request"
